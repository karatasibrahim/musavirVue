...
faaliyetget(space)
  ...
  console.log(this.popup.FaaliyetAlani, this.faaliyetdata);
    ...
    ...mapActions(["addkalanıd","addMükellefid","AddNewBeyanTakip","AddNewsssMükellef","DeleteSgkData","fetchİlce","fetchİller","fetchFaaliyet","fetchKalanBeyanname","fetchBeyanTakipProperties","uptadeSgkFirma","fetchSgkFirmaalar", "AddNewSgkData"]),
        inquireClick() {
      this.popup.iletisim=this.iletisimdata
      this.popup.FaaliyetAlani=this.faaliyetdata
console.log(this.popup);
console.log(this.MukellefId);
 this.AddNewsssMükellef(this.popup)
    },
    //#endregion
   getsgkdata(data){
     console.log(data);
    ...
    this.iletisimdata.push(obj)
     ...
     console.log(data);
          let obj = {
            ...
            Durum: false,
            MetreKare: "",
            MukellefId: this.popup.MukellefId,
            SicilNo: "",
...
fetchIlAndIlce(){
this.fetchİller()
     this.addMükellefid().then(res=>{
        console.log(res);
        this.popup.MukellefId=res
                console.log( this.popup.MukellefId);

        })
        this.addkalanıd().then(res=>{
          this.KalanId=res
        })
},
faaliyetget(){
...
let id = dataa.length==0?this.KalanId:dataa[0].KalanId
console.log(dataa);
      let obj = {
        KalanId: id,
        KontrolAraligi: 0,
