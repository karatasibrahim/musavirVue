  ...
  >
    ...
    <div class="customizer-section d-flex justify-content-between align-items-center">
      <div>
        ...
        <small>Opsiyonel &amp; Sürdürülebilir Tema Ayarları</small>
      </div>
      <feather-icon
        icon="XIcon"
        size="18"
    ...
    >
      ...
      <div class="customizer-section">
        ...
        <!-- Skin -->
        <b-form-group label="Sayfa Genişliği">
          <b-form-radio-group
      ...
      <div class="customizer-section">
        ...
        >
          <span class="font-weight-bold">Menü Daraltma</span>
          <b-form-checkbox
        ...
        <div class="d-flex justify-content-between align-items-center mt-2">
          <span class="font-weight-bold">Menü Gizleme</span>
          <b-form-checkbox
      ...
      <div class="customizer-section">
        ...
        <!-- Navbar Type -->
        <b-form-group :label="layoutType === 'vertical' ? 'Üst Menü Ayarı' : 'Menu Type'">
          <b-form-radio-group
            v-model="navbarType"
            name="navbar-type"
            :options="navbarTypes"
      ...
      <div class="customizer-section">
        ...
        <!-- Footer Type -->
        <b-form-group label="Alt Bilgi Alanı">
          <b-form-radio-group
            v-model="footerType"
            name="footer-type"
            :options="footerTypes"
